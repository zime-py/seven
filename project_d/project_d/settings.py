...
SECRET_KEY = 'jg_^55wga&b(i@$!7g)543e+(ri^xrlwuzalcqo2dnwgzr*=^('
...
REST_FRAMEWORK = {   #this is rest pase authenticate pannel
...
#'rest_framework.permissions.IsAuthenticatedOrReadOnly', #unauthorized users can view any page, but only
